...
Gemini 3.6 Flash has access to all agent tools when used with Cursor including:
...
Cursor [plans](https://cursor.com/docs/models-and-pricing.md) include two usage pools. Gemini 3.6 Flash draws from the third-party **Other Models** pool, which charges at the rates below. All prices are per million tokens.
