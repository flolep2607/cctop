...
pub(super) fn draw_help(frame: &mut Frame, area: Rect, app: &mut App) {
    ...
    let lines = vec![
        ...
        item("", "and nothing here can reach it. Either copy the file"),
        item("", "over yourself (scp) and type its path, or paste the"),
        item("", "image as base64 text — cctop recognises one and"),
        item("", "files it. To make base64, where your clipboard is:"),
