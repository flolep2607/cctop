...
working in this checkout, how to verify the way CI does, why cctop targets Linux
alone, why `cctop hook` must never fail, and how to title a pull request so the
release note it becomes is worth reading.
